...
def ver_detalle():
    ...
    if selected_index:
        ...
        boton_reservar_auto = tk.Button(ventana_secundaria_det, text="Reservar",relief=tk.FLAT, fg="white", bg="steel blue",command=lambda: reservar_auto(auto_seleccionado, ventana_secundaria_det))
